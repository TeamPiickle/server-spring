...
public class BallotService {
    ...
    private void validBallotTopic(String ballotTopicId) {
        BallotTopic ballotTopic = ballotTopicRepository.findById(String.valueOf(ballotTopicId))
    ...
    public List<BallotTopicResponseDto> getBallotTopicList(String userEmail) {
        if (userEmail == null) {
            ...
            return ballotTopicList.stream()
                    .map(ballotTopic -> new BallotTopicResponseDto(ballotTopic))
    ...
    private List<BallotTopic> getTopicListForGuest(String userId) {
        if (userId == null) {
            return ballotTopicRepository.findAllOrderByOrder(PageRequest.of(0, 4));
        }
    ...
    public BallotStatusDto getBallotStatusAndUserSelect(String ballotTopicId, String userEmail) {
        ...
        List<BallotStatusDto.BallotItem> ballotItemWithStatusList = ballotItems.stream()
                .map(value -> {
                    ...
                    return BallotStatusDto.BallotItem.builder()
                            .id(value.getId())
                            .status(status)
        ...
        return BallotStatusDto.builder()
                ...
                .ballotTopic(BallotStatusDto.BallotTopic
                        .builder()
                        .id(ballotTopicId)
                        .ballotTopicContent(ballotTopic.getTopic())
                        .build())
