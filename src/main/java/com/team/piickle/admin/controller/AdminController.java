...
public class AdminController {
    ...
    @PostMapping(value = "/addExcel", consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.MULTIPART_FORM_DATA_VALUE})
    public ResponseEntity<ResponseDto> addExcel(@RequestPart(required = false) MultipartFile cardExcel) throws IOException {
    ...
    private ResponseEntity<ResponseDto> getCards() {
        ...
        return new ResponseEntity<>(DataResponseDto.of(signUpUsers, messageSource.getMessage("USER.PROFILE.VIEW.SUCCESS", null, Locale.getDefault())), HttpStatus.OK);
    }
